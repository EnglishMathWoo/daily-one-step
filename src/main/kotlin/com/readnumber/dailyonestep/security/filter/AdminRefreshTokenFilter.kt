...
// FIXME: 리펙토링 해야함.
class AdminRefreshTokenFilter(
    private val tokenProvider: AdminRefreshTokenProvider
) : OncePerRequestFilter() {
    val matchers = arrayOf(
        AntPathRequestMatcher("/admin-api/access-tokens/refresh"),
        AntPathRequestMatcher("/admin-api/sign-out")
    )
