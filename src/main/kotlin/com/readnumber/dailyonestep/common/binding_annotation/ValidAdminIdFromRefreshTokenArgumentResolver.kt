...
@Component
class ValidAdminIdFromRefreshTokenArgumentResolver : HandlerMethodArgumentResolver {
    @Autowired
    lateinit var accessTokenProvider: AdminRefreshTokenProvider

    override fun supportsParameter(methodParameter: MethodParameter): Boolean {
        return methodParameter.getParameterAnnotation(ValidAdminIdFromRefreshToken::class.java) != null
    }
