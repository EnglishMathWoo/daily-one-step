...
@Component
class ValidUserIdFromAccessTokenArgumentResolver : HandlerMethodArgumentResolver {
    @Autowired
    lateinit var accessTokenProvider: UserAccessTokenProvider

    override fun supportsParameter(methodParameter: MethodParameter): Boolean {
        return methodParameter.getParameterAnnotation(ValidUserIdFromAccessToken::class.java) != null
    }
